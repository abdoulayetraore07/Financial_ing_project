...
def main():
    ...
    choix = input("Entrez votre choix (0-14): ")
    print("\n")
    ...
    if choix == "0":
        ...
        discriminant_VC (valeurs_B, nb_simul= 25000,  S0=1, r=0.015, T=2, sigma=0.15, K=1, alph=0.1, delta = 1/52, m_covariance = False, r_variance = True)
