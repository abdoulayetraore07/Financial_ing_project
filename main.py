...
def main():
    ...
    9 - Option barriere P_DO approximé
    ...
    choix = input("Entrez votre choix (0-11): ")
    print("\n")
    
    ### Paramètres communs
    nb_simul_list = [1000, 3000, 5000, 8000, 13000, 25000, 40000, 65000, 90000, 120000, 500000, 1000000]
    ...
    if choix == "0":
        ...
        # Option barriere P_DO approximé
        ...
        comparer_delta_DO_et_DO_delta(valeurs_delta = valeurs_delta, nb_simul = nb_simul_precis, S0=1, r=0.015, T=2, sigma=0.15, K=1, alph=0.1, B = 0.7, m_covariance = False, r_variance = True)  

    elif choix =='11':
        # Comparaison de probabilité de non-sortie sous ksi_DO_delta et ksi_DO en fonction de delta
        comparer_proba_non_sortie_delta(valeurs_delta = valeurs_delta, nb_simul = nb_simul_precis, S0=1, r=0.015, T=2, sigma=0.15, K=1, alph = 0.1, B = 0.7, m_covariance = False, r_variance = False)

    else:
        print("Choix invalide. Veuillez entrer un nombre entre 0 et 8.")
